# herdr — full reference

For the gate check, concepts, and the most common commands, see [SKILL.md](SKILL.md). This file covers tab and workspace management, `pane close`, ready-made recipes, and the full notes.
