...
//
// A marker records which workhub task one agent session is working; it lives at
// `<vault>/_ai/memory/sessions/<session-key>.json` and is written by
...
// `session-marker-read.test.mjs` pins this copy against the original so the
