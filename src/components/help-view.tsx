...
- **Callouts render as coloured boxes** — Obsidian's \`> [!note]\` / \`> [!warning]\` (with a custom title, and \`-\` / \`+\` to fold), NotePM's \`:::note info|warn|alert\` and Zenn's \`:::message\` / \`:::message alert\`. Click a foldable callout's title to open or close it. Code blocks are not syntax-highlighted.
