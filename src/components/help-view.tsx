          ...
          >
            ...
            <ul className="ml-4 list-disc space-y-1.5">
              ...
              <li>
                ...
                document. An image pointing at an <span className="font-mono text-xs">https:</span> URL loads once
                the gear button&apos;s{" "}
                <span className="font-medium text-foreground">Load images from https: URLs</span> is on; off, it
                reads as unreadable.
              </li>
              <li>
