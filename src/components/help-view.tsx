        ...
        >
          ...
          >
            ...
            <ul className="ml-4 list-disc space-y-1.5">
              ...
              <li>
                <span className="font-medium">Repositories</span> links the project
                to the repositories registered on the Repos tab. The list is stored
                as <span className="font-mono text-xs">repos:</span> in the
                project&apos;s{" "}
                ...
                the name, because the two do not share a naming scheme. A project
                may legitimately span several — an app and its vault, say — and the
                first entry is the one an agent defaults to.
              </li>
              <li>
              ...
              <li>
                ...
                edited in the detail pane and stored as{" "}
                <span className="font-mono text-xs">title:</span> and{" "}
                <span className="font-mono text-xs">description:</span> in the
                project&apos;s README.md. The folder slug does not change, so
                task <span className="font-mono text-xs">project:</span> values
                stay valid. An empty description falls back to the first prose
          ...
          >
            ...
            <ul className="ml-4 list-disc space-y-1.5">
              ...
              <li>
                ...
                date shown in a filled pill. The{" "}
                <span className="font-medium">Today</span> button next to the
                date range scrolls to it — and if today is outside the displayed
                range, it moves the range onto today first.
              </li>
              <li>
                <span className="font-medium text-foreground">
                  Change the displayed range without the date pickers
                </span>
                : over the calendar, <Kbd>Shift</Kbd>+<span className="mx-1">wheel</span>
                moves the range a week at a time, and <Kbd>Ctrl</Kbd>+
          ...
          >
            ...
            <ul className="ml-4 list-disc space-y-1.5">
              ...
              <li>
                ...
                request for an AI agent — the file&apos;s path, the line and the quote for each note, and an
                instruction to re-read the file and not to overwrite a share without asking. Paste that into Claude
                Code or OpenCode and the agent does the editing. Notes are this PC&apos;s own (like Recent files) and
